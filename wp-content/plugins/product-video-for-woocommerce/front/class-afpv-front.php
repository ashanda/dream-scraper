					...
					if ( 'yes' == $afpv_enable_featured_image_as_first_img) { 
						...
						?>
							<a href="<?php echo esc_url(get_the_post_thumbnail_url()); ?>" class="zoom html5lightbox pv-thumbnail-width afpv-product-feature-img" data-width="900" data-height="600">
								...
								<img class="attachment-shop_thumbnail size-shop_thumbnail" src="<?php echo esc_url( get_the_post_thumbnail_url()); ?>" width="<?php echo esc_attr($afpv_tp_video_width); ?>" height="<?php echo esc_attr($afpv_tp_video_height); ?>" />
							</a>
							<a href="<?php echo esc_url(get_permalink($post->ID)); ?>">
						<?php
