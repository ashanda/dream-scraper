...
<div class="back_imgs">
    <img class="left_hand" src="<?php echo get_template_directory_uri(); ?>/inc/img/left_hand.png" alt="">
    <img class="heart" src="<?php echo get_template_directory_uri(); ?>/inc/img/heart.png" alt="">
    <img class="right_hand" src="<?php echo get_template_directory_uri(); ?>/inc/img/right_hand.png" alt="">
</div>
<div class="key_icon">
                ...
                <div id="year1" class="dy-default tabcontent">
                    <table>
                        <tr>
                            <td>
                                <div class="dy-img">
                                    <img class="img-fluid" src="inc/img/samp1.jpg" alt="">
                                </div>
                            </td>
                            <td>
                ...
                <div id="year2" class="tabcontent">
                    <table>
                        <tr>
                            <td>
                                <div class="dy-img">
                                    <img class="img-fluid" src="inc/img/samp2.jpg" alt="">
                                </div>
                            </td>
                            <td>
                                <div class="dy-caption">
                ...
                <div id="year3" class="tabcontent">
                    <table>
                        <tr>
                            <td>
                                <div class="dy-img">
                                    <img class="img-fluid" src="inc/img/samp3.jpg" alt="">
                                </div>
                            </td>
                            <td>
                                <div class="dy-caption">
                ...
                <div id="year4" class="tabcontent">
                    <table>
                        <tr>
                            <td>
                                <div class="dy-img">
                                    <img class="img-fluid" src="inc/img/samp4.jpg" alt="">
                                </div>
                            </td>
                            <td>
                                <div class="dy-caption">
                ...
                <div id="year5" class="tabcontent">
                    <table>
                        <tr>
                            <td>
                                <div class="dy-img">
                                    <img class="img-fluid" src="inc/img/samp5.jpg" alt="">
                                </div>
                            </td>
                            <td>
                                <div class="dy-caption">
